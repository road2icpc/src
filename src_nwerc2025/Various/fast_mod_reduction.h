...
//# Title: fast mod reduction
//# Description: [kactl] Compute $a \% b$ about 5 times faster than usual, where $b$ is constant but not known at compile time. Returns a value congruent to $a \pmod b$ in the range $[0, 2b)$.
