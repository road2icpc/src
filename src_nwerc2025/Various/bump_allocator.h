...
//# Description: [kactl] When you need to dynamically allocate many objects and don't care about freeing them. \texttt{new X} otherwise has an overhead of something like 0.05us + 16 bytes per allocation.
