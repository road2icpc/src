//# Title: Line hull intersection
//# Description: Yoinked from kactl. Line-convex polygon intersection. The polygon must be ccw and have no collinear points. \texttt{lineHull(line, poly)} returns a pair describing the intersection of a line with the polygon:
//# \begin{itemize}
